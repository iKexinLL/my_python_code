...
out_path = r'E:\my_work\工作\定报\备份\hawq_function_%s'%the_date
...
#HAWQ 库
conn = psy.connect(database = 'jlbdbi', host = '10.163.169.31', user = 'chkuser', password = 'C#hkuser70bonc', port = '5432')
...
where p.proname like 'p_dw%' -- 这里修改
order by 1'''
